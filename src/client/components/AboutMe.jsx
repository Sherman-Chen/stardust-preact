  ...
  return (
    <main className='flex-wrapper'>
      ...
      <section className="blurb">
        ...
        <p tabindex="2"><i className="fa fa-rocket icon"></i>Placed 2nd at Reactathon 2017 & Devweek 2017 Hackathon API Challenges, winning prizes, meeting people, and free food, what's not to love?</p>    
