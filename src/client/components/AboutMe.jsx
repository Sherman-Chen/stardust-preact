  ...
  return (
    <main className='flex-wrapper'>
      ...
      <section className="blurb">
        ...
        <p><i className="fa fa-rocket icon"></i>Placed 2nd at Devweek 2017 Hackathon Flock Challenge! Won cash prize and gadgets! Exciting experience, looking forward to competing in more!</p>    
        <p><i className="fa fa-hand-peace-o icon"></i>When not developing I can usually be found exercising, playing tennis, learning something new, listening to podcasts, or planning out my next personal project!</p>
