...
const Resume = () => {
  return (
    <main className='flex-wrapper'>
      ...
      <section className='blurb'>
        <h1 tabindex="1">I'm actively job searching at the moment!</h1>
          <ul>
            ...
            <li><i className="fa fa-info icon"></i>Let's get in <a href="/contact" className="link">contact</a> if I sound like someone you might want to work with!</li>
          </ul>
      </section>
      <section className="blurb">
      ...
      <section className="blurb">
        <h3 tabindex="3">Skills</h3>
        <ul>
          <li tabindex="4"><i className="fa fa-pencil icon"></i><b>Frontend</b>: In past projects I have used React, React Native, and Angular. I have experience with jQuery, and Backbone as well. Really excited with the potential of Vue.js. I make a committment to building responsive, cross-browser compatible, acessibility for all, and mobile first design applications.</li>
          <li tabindex="5"><i className="fa fa-cogs icon"></i><b>Backend</b>: For the server side of things I program mostly in Node with the Express framework, and use Websockets on occasion. Currently exploring the Django framework.</li>
          <li tabindex="6"><i className="fa fa-database icon"></i><b>Databases</b>: I'm a nice guy, but I'm also a MEA/RN guy so MongoDB is my go to. I have also utilized MySQL, MariaDB, and SQLite before.</li>
          <li tabindex="7"><i className="fa fa-code-fork icon"></i><b>Version Control</b>: In event of fire, git checkout -b ahhhhhfire, git add -A (it's an emergency!), git push origin ahhhhhfire, calmly exit building. Git saves lives, frequent commits prevent headaches.</li>
          <li tabindex="8"><i className="fa fa-terminal icon"></i><b>Build</b>: Webpack and NPM scripts are cool, have also used Grunt, Gulp, and Bower.</li>
          <li tabindex="9"><i className="fa fa-globe icon"></i><b>Deployment</b>: I'm not the most skilled at DevOps, but I'm constantly improving. This site is actively deployed via Heroku, and previous applications were deployed using Heroku, AWS, and Digital Ocean. Docker is pretty neat, containerize everything! I do my best to write scripts in Bash, and Ruby.</li>
          <li tabindex="10"><i className="fa fa-code icon"></i><b>Languages</b>: JavaScript, HTML, CSS, Python, some Ruby, and some Java. I can speak English, and Chinese and am always looking to pick up new languages programming and conversational!</li>
          <li tabindex="11"><i className="fa fa-asterisk icon"></i><b>Others</b>: I also have experience with design tools like Sketch and PhotoShop, and write tests using Mocha, Chai, Jasmine, Karma, and so forth. Have used Continous Integration tools such as CircleCi and TravisCi.</li>
        </ul>
      </section>
      <section className='blurb'>
